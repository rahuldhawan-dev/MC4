<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iInterconnectionTest.aspx.cs" Inherits="MapCall.Modules.Maps.iInterconnectionTest" %>
...
<body style="background-color:White;background-image:none;">
    ...
    <cc1:TabContainer runat="server" ID="tcMain" ActiveTabIndex="0">
        <cc1:TabPanel runat="server" HeaderText="Interconnection Test" ID="tabInterconnectionTest">
            <ContentTemplate>
                <!-- This should show up -->
                <mmsi:DataElement runat="server" ID="DataElement1" 
                    DataElementName="Interconnection Test" 
                    DataElementParameterName="InterconnectionTestID"
                    DataElementTableName="InterconnectionTests" 
                    AllowDelete="false" AllowEdit="false" AllowNew="false"
                     />

                <mmsi:Notes ID="ntsMain" runat="server" DataTypeID="86" />
                <mmsi:Documents ID="dcsMain" runat="server" DataTypeID="86" />
            </ContentTemplate>
        </cc1:TabPanel>
    </cc1:TabContainer>
    </div>
