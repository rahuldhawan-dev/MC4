<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ICriticalCustomers.aspx.cs" Inherits="MapCall.Modules.Maps.ICriticalCustomers" %>
...
<body style="background-color:White;background-image:none;">
    ...
    <cc1:TabContainer runat="server" ID="tcMain" ActiveTabIndex="0">
        <cc1:TabPanel runat="server" HeaderText="Critical Customers" ID="tabCritCust">
            <ContentTemplate>
                <!-- This should show up -->
                <mmsi:DataElement runat="server" ID="DataElement1" 
                    DataElementName="Critical Customers" 
                ...
                <mmsi:Notes ID="ntsMain" runat="server" DataTypeID="75" />
                <mmsi:Documents ID="dcsMain" runat="server" DataTypeID="75" />
            </ContentTemplate>
        </cc1:TabPanel>
    </cc1:TabContainer>
    </div>
