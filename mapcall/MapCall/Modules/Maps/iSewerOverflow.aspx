<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iSewerOverflow.aspx.cs" Inherits="MapCall.Modules.Maps.iSewerOverflow" %>
...
<body style="background-color:White;background-image:none;">
    ...
    <cc1:TabContainer runat="server" ID="tcMain" ActiveTabIndex="0">
        <cc1:TabPanel runat="server" HeaderText="Event Details" ID="tabEventDetails">
            <ContentTemplate>
                <!-- This should show up -->
                <mmsi:DataElement runat="server" ID="DataElement1" DataElementName="Sewer Overflow" 
                    DataElementParameterName="SewerOverflowID"
                    DataElementTableName="SewerOverflows"  
                    ConnectionString="MCprod"
                    AllowDelete="false" 
                    AllowEdit="false" 
                    AllowNew="false" />

                <mmsi:Notes ID="ntsMain" runat="server" DataTypeID="97" />
                <mmsi:Documents ID="dcsMain" runat="server" DataTypeID="97" />
            </ContentTemplate>
        </cc1:TabPanel>
    </cc1:TabContainer>
    </div>
