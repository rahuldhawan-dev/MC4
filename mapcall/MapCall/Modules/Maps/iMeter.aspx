<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iMeter.aspx.cs" Inherits="MapCall.Modules.Maps.iMeter" %>
...
<body style="background-color:White;background-image:none;">
    ...
    <cc1:TabContainer runat="server" ID="tcMain" ActiveTabIndex="0">
        <cc1:TabPanel runat="server" HeaderText="Meter Details" ID="tabMeterDetails">
            <ContentTemplate>
                <!-- This should show up -->
                <mmsi:DataElement runat="server" ID="DataElement1" 
                    DataElementName="Meter" 
                    ConnectionString="MCprod"
                    DataElementParameterName="MeterID"
                    DataElementTableName="Meters" 
