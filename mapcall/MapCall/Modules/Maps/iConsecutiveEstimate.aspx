<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iConsecutiveEstimate.aspx.cs" Inherits="MapCall.Modules.Maps.iConsecutiveEstimate" %>
...
<body style="background-color:White;background-image:none;">
    ...
    <cc1:TabContainer runat="server" ID="tcMain" ActiveTabIndex="0">
        <cc1:TabPanel runat="server" HeaderText="Consecutive Estimate" ID="tabCE">
            <ContentTemplate>
                <!-- This should show up -->
                ...
                <mmsi:Notes ID="ntsMain" runat="server" DataTypeID="79" />
                <mmsi:Documents ID="dcsMain" runat="server" DataTypeID="79" />
            </ContentTemplate>
        </cc1:TabPanel>
    </cc1:TabContainer>
    </div>
