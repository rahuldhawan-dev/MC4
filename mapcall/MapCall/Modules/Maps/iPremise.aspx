<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="iPremise.aspx.cs" Inherits="MapCall.Modules.Maps.iPremise" %>
...
<body>
    ...
    <cc1:TabContainer runat="server" ID="tcMain" ActiveTabIndex="0">
        <cc1:TabPanel runat="server" HeaderText="Premise Details" ID="tabPremises">
            <ContentTemplate>
                <!-- This should show up -->
                <mmsi:DataElement runat="server" ID="DataElement1" 
                    DataElementName="Premise" 
                    ConnectionString="MCprod"
                    DataElementParameterName="PremiseID"
                    DataElementTableName="Premises" 
                    AllowDelete="false" AllowEdit="false" AllowNew="false"
                     />

                <mmsi:Notes ID="ntsMain" runat="server" DataTypeID="105" />
                <mmsi:Documents ID="dcsMain" runat="server" DataTypeID="105" />
            </ContentTemplate>
        </cc1:TabPanel>
    </cc1:TabContainer>
    </div>
