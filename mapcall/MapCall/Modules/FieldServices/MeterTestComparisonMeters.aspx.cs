...
{
    public partial class MeterTestComparisonMeters : DataElementPage
    {
        #region Properties
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            MeterTestComparisonPoints1.MeterTestComparisonMeterID = id;
            MeterTestComparisonPoints1.DataBind();
        ...
        protected override void DataElement1_ItemInserted(object sender, EventArgs e)
        {
            ...
            MeterTestComparisonPoints1.MeterTestComparisonMeterID =
                DataElement1.DataElementID;
            MeterTestComparisonPoints1.DataBind();
        }
