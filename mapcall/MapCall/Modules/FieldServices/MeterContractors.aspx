<%@ Page Title="Meter Contractors" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="MeterContractors.aspx.cs" Inherits="MapCall.Modules.FieldServices.MeterContractors" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="MeterContractorID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM MeterContractors;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="MeterContractors"
            DataElementParameterName="MeterContractorID"
            DataElementTableName="MeterContractors"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="133" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="133" />
        <br />
        <center>
