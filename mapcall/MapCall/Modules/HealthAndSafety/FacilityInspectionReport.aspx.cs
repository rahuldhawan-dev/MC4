...
namespace MapCall.Modules.HealthAndSafety
{
    public partial class FacilityInspectionReport : DataElementPage
    {
        #region Properties
        ...
        protected override IModulePermissions ModulePermissions
        {
            get
            {
                return Operations.HealthAndSafety;
            }
        }
        ...
        {
            Response.Redirect("~/Modules/mvc/HealthAndSafety/ApcInspectionItem/Search");
