<%@ Page Title="Service Order Categories" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="ServiceOrderCategories.aspx.cs" Inherits="MapCall.Modules.Customer.ServiceOrderCategories" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ServiceOrderCategoryID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM ServiceOrderCategories;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="ServiceOrderCategories"
            DataElementParameterName="ServiceOrderCategoryID"
            DataElementTableName="ServiceOrderCategories"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="114" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="114" />
        <br />
        <center>
