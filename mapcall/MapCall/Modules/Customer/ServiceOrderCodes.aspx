<%@ Page Title="Service Order Codes" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="ServiceOrderCodes.aspx.cs" Inherits="MapCall.Modules.Customer.ServiceOrderCodes" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ServiceOrderCodeID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM ServiceOrderCodes;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="ServiceOrderCodes"
            DataElementParameterName="ServiceOrderCodeID"
            DataElementTableName="ServiceOrderCodes"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="106" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="106" />
        <br />
        <center>
