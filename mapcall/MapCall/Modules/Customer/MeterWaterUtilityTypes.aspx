<%@ Page Title="Meter Water Utility Types" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="MeterWaterUtilityTypes.aspx.cs" Inherits="MapCall.Modules.Customer.MeterWaterUtilityTypes" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlSearch" DefaultButton="btnSearch">
        ...
        <table style="text-align:left;" border="0">
            ...
            <mmsi:DataField runat="server" ID="dfNote" DataType="String" DataFieldName="Note" HeaderText="Note:" />
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="MeterWaterUtilityTypeID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM MeterWaterUtilityTypes;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="MeterWaterUtilityTypes"
            DataElementParameterName="MeterWaterUtilityTypeID"
            DataElementTableName="MeterWaterUtilityTypes"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="119" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="119" />
        <br />
        <center>
