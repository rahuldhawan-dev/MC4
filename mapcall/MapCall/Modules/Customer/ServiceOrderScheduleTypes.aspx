<%@ Page Title="Service Order Schedule Types" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="ServiceOrderScheduleTypes.aspx.cs" Inherits="MapCall.Modules.Customer.ServiceOrderScheduleTypes" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ServiceOrderScheduleTypeID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM ServiceOrderScheduleTypes;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="ServiceOrderScheduleTypes"
            DataElementParameterName="ServiceOrderScheduleTypeID"
            DataElementTableName="ServiceOrderScheduleTypes"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="115" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="115" />
        <br />
        <center>
