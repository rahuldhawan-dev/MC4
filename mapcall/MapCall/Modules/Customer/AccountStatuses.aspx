<%@ Page Title="Account Statuses" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="AccountStatuses.aspx.cs" Inherits="MapCall.Modules.Customer.AccountStatuses" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="AccountStatusID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM AccountStatuses;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="AccountStatuses"
            DataElementParameterName="AccountStatusID"
            DataElementTableName="AccountStatuses"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="112" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="112" />
        <br />
        <center>
