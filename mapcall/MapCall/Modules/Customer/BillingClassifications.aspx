<%@ Page Title="Billing Classifications" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="BillingClassifications.aspx.cs" Inherits="MapCall.Modules.Customer.BillingClassifications" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlSearch" DefaultButton="btnSearch">
        ...
        <table style="text-align:left;" border="0">
            <mmsi:DataField runat="server" ID="dfNumber" DataType="String" DataFieldName="Number" HeaderText="Number:" />
            <mmsi:DataField runat="server" ID="dfName" DataType="String" DataFieldName="Name" HeaderText="Name:" />
            <mmsi:DataField runat="server" ID="dfDefinition" DataType="String" DataFieldName="Definition" HeaderText="Definition:" />
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="BillingClassificationID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM BillingClassifications;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="BillingClassifications"
            DataElementParameterName="BillingClassificationID"
            DataElementTableName="BillingClassifications"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="109" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="109" />
        <br />
        <center>
