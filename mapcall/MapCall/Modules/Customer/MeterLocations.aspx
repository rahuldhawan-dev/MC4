<%@ Page Title="Meter Locations" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="MeterLocations.aspx.cs" Inherits="MapCall.Modules.Customer.MeterLocations" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="MeterLocationID" AllowSorting="true"
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="MeterLocations"
            DataElementParameterName="MeterLocationID"
            DataElementTableName="MeterLocations"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="110" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="110" />
        <br />
        <center>
