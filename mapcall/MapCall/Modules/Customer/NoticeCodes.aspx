<%@ Page Title="Notice Codes" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="NoticeCodes.aspx.cs" Inherits="MapCall.Modules.Customer.NoticeCodes" %>
...
<asp:Label runat="server" ID="lblPermissionErrors" />
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="NoticeCodeID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM NoticeCodes;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="NoticeCodes"
            DataElementParameterName="NoticeCodeID"
            DataElementTableName="NoticeCodes"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="118" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="118" />
        <br />
        <center>
