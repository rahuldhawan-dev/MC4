<%@ Page Title="Service Order Types" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="ServiceOrderTypes.aspx.cs" Inherits="MapCall.Modules.Customer.ServiceOrderTypes" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ServiceOrderTypeID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM ServiceOrderTypes;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="ServiceOrderTypes"
            DataElementParameterName="ServiceOrderTypeID"
            DataElementTableName="ServiceOrderTypes"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="113" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="113" />
        <br />
        <center>
