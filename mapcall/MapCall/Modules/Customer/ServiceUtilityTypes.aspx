<%@ Page Title="Service Utility Types" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="ServiceUtilityTypes.aspx.cs" Inherits="MapCall.Modules.Customer.ServiceUtilityTypes" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlSearch" DefaultButton="btnSearch">
        ...
        <table style="text-align:left;" border="0">
            <mmsi:DataField runat="server" ID="dfType" DataType="String" DataFieldName="Type" HeaderText="Type:" />
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ServiceUtilityTypeID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM ServiceUtilityTypes;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="ServiceUtilityTypes"
            DataElementParameterName="ServiceUtilityTypeID"
            DataElementTableName="ServiceUtilityTypes"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="117" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="117" />
        <br />
        <center>
