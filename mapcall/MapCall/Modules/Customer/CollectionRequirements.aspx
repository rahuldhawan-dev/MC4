<%@ Page Title="Collection Requirements" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="CollectionRequirements.aspx.cs" Inherits="MapCall.Modules.Customer.CollectionRequirements" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlSearch" DefaultButton="btnSearch">
        ...
        <table style="text-align:left;" border="0">
            <%--<mmsi:DataField runat="server" ID="dsCollectionRequirementID" DataType="Integer" DataFieldName="CollectionRequirementID" HeaderText="CollectionRequirementID:" />--%>
            <mmsi:DataField runat="server" ID="dfPhase" DataType="String" DataFieldName="Phase" HeaderText="Phase:" />
            <mmsi:DataField runat="server" ID="dfCollections" DataType="String" DataFieldName="Collections" HeaderText="Collections:" />
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="CollectionRequirementID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM CollectionRequirements;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="CollectionRequirements"
            DataElementParameterName="CollectionRequirementID"
            DataElementTableName="CollectionRequirements"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="122" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="122" />
        <br />
        <center>
