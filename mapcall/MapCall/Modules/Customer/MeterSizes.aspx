<%@ Page Title="Meter Sizes" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="MeterSizes.aspx.cs" Inherits="MapCall.Modules.Customer.MeterSizes" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlSearch" DefaultButton="btnSearch">
        ...
        <table style="text-align:left;" border="0">
            <mmsi:DataField runat="server" ID="dfSize" DataType="String" DataFieldName="Size" HeaderText="Size:" />
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="MeterSizeID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM MeterSizes;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="MeterSizes"
            DataElementParameterName="MeterSizeID"
            DataElementTableName="MeterSizes"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="111" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="111" />
        <br />
        <center>
