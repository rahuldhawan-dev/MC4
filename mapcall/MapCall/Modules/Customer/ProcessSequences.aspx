<%@ Page Title="Process Sequences" Language="C#" AutoEventWireup="true" MasterPageFile="~/MapCallSite.Master" Theme="bender" CodeBehind="ProcessSequences.aspx.cs" Inherits="MapCall.Modules.Customer.ProcessSequences" %>
...
<asp:Content ID="Content3" runat="server" ContentPlaceHolderID="cphMain">
    ...
    <asp:Panel runat="server" ID="pnlResults" Visible="false">
        ...
        <asp:GridView ID="GridView1" runat="server" DataSourceID="SqlDataSource1" 
            OnSelectedIndexChanged="GridView1_SelectedIndexChanged" DataKeyNames="ProcessSequenceID" AllowSorting="true"
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
           SelectCommand="SELECT * FROM ProcessSequences;"
        >
        </asp:SqlDataSource>
    </asp:Panel>
    ...
    <asp:Panel runat="server" ID="pnlDetail" Visible="false">
        <mmsi:DataElement runat="server" ID="DataElement1" 
            ...
            DataElementName="ProcessSequences"
            DataElementParameterName="ProcessSequenceID"
            DataElementTableName="ProcessSequences"
        ...
        <mmsi:Notes ID="Notes1" runat="server" DataTypeID="116" />
        <mmsi:Documents ID="Documents1" runat="server" DataTypeID="116" />
        <br />
        <center>
