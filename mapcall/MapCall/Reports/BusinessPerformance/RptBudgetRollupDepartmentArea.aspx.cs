...
{
    public partial class RptBudgetRollupDepartmentArea : DataElementPage
    {
        #region Large SQL Text
        private const string SQL = @"Select 
                ...
                GROUP BY 
	                dep.Description, #4.Description, [BudgetYear], #1.LookupValue, #2.ExpenseLine, Budget_Category
                ORDER BY 1, 2, 3, 4";
        #endregion
        ...
        protected void Page_PreRender(object sender, EventArgs e)
        {
            ...
            cws.SeriesNames = !string.IsNullOrEmpty(dfExpenseLine.CurrentValue.ToString()) ? 
                new[] { "Department", "Area", "BudgetYear", "Budget Category", "ExpenseLine" } 
                : new[] { "Department", "Area", "BudgetYear", "Budget Category" };
