...
{
    public partial class StrategicElementsInitiatives : ReportPage
    {
        #region Properties
        ...
        private void ApplyGrouping()
        {
            ...
            helper.RegisterGroup("StrategyName", true, true);
            helper.RegisterGroup("ElementName", true, true);
        ...
        {
            if (groupName == "StrategyName" || groupName == "ElementName")
            {
