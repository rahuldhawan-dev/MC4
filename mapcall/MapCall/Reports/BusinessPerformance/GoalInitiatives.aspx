<%@ Page Title="Goals - Business Performance Initiatives" Theme="bender" Language="C#" MasterPageFile="~/MapCallSite.Master" AutoEventWireup="true" CodeBehind="GoalInitiatives.aspx.cs" Inherits="MapCall.Reports.BusinessPerformance.GoalInitiatives" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="cphHeader" runat="server">
    Goals - Business Performance Initiatives
</asp:Content>
            ...
            <tr>
                <td>
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" 
                        ...
                        <Columns>
                           <mmsinc:BoundField DataField="Goal" HeaderText="Goal" />
                    ...
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:MCProd %>"
                        SelectCommand="
select
	Goal, I.Initiative_Summary, Strategic_Element, Initiative_ID, Initiative_Focus, Implementation_Horizon, Priority_Ranking, Goal_ID
from
