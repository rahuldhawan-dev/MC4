...
{
    public partial class WQComplaintsDetails : Page
    {
    #region Constants
    ...
    #region Event Handlers
        ...
        protected void btnView_Click(object sender, EventArgs e)
        {
            ...
            ReportViewer1.LocalReport.DataSources.Add(new ReportDataSource("DSReports2_rptWQComplaints", "ObjectDataSource1"));
            ReportViewer1.LocalReport.ReportPath = "Reports\\WaterQuality\\rptWQComplaints.rdlc";
