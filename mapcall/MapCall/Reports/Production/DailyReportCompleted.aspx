<%@ Page Language="C#" MasterPageFile="~/MapCall.Master" theme="bender" AutoEventWireup="true" CodeBehind="DailyReportCompleted.aspx.cs" Inherits="MapCall.Reports.Production.DailyReportCompleted" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <table id="outer" style="width:100%;" cellpadding="4" class="RptTable" >
        <tr>
            <td colspan="6" class="RptHeader">
                Daily Report - Completed Work Orders
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td style="width:100%;" colspan="3">
                <rsweb:ReportViewer ID="ReportViewer1" runat="server" Font-Names="Verdana" Font-Size="8pt"
                    ...
                    <LocalReport ReportPath="Reports\Production\DailyReportCompleted.rdlc">
                        <DataSources>
                            <rsweb:ReportDataSource DataSourceId="ObjectDataSource1" Name="DSProduction_rptProd_DailyReportCompleted" />
                        </DataSources>
                    </LocalReport>
                </rsweb:ReportViewer>
                <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetData"
                    TypeName="MapCall.DSProductionTableAdapters.rptProd_DailyReportCompletedTableAdapter"
                    >
                    <SelectParameters>
...
<script type="text/javascript">
    ...
    var hght = document.body.clientHeight-135;
