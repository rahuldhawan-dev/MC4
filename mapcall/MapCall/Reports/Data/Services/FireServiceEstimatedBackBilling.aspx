<%@ Page Title="Fire Services - Estimated Back Billing" Theme="bender" Language="C#" MasterPageFile="~/MapCallSite.Master" AutoEventWireup="true" CodeBehind="FireServiceEstimatedBackBilling.aspx.cs" Inherits="MapCall.Reports.Data.Services.FireServiceEstimatedBackBilling" %>
...
Select 
	...
	DistrictCode,
	AreaCodeDescription,
		(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 1 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Jan],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 2 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Feb],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 3 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Mar],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 4 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Apr],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 5 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [May],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 6 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Jun],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 7 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Jul],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 8 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Aug],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 9 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Sep],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 10 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Oct],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 11 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Nov],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode and Month(fs.BillingRestartDate) = 12 group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as [Dec],
	(Select Sum(EstimatedBackBillValue) from InactiveServices as fs where fs.AreaCodedescription = InactiveServices.AreaCodeDescription and fs.DistrictCode = InactiveServices.DistrictCode group by year(fs.BillingRestartDate) having year(fs.BillingRestartDate) = year(InactiveServices.BillingRestartDate)) as Total
from 
    InactiveServices
Where
    FireService = 1
