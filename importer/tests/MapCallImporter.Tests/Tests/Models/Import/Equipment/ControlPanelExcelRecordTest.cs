...
{
    [TestClass]
    public class ControlPanelExcelRecordTest : EquipmentExcelRecordTestBase<ControlPanelExcelRecord>
    {
        #region Private Methods

        protected override ControlPanelExcelRecord CreateTarget()
        {
        ...
        protected override string ExpectedIdentifier => "NJ7-10-CTPG-1";
        ...
        protected override void TestCharacteristicMappings(
            EquipmentCharacteristicMappingTester<ControlPanelExcelRecord> test)
        {
            test.Numerical(x => x.AmpRating, "AMP_RATING");
            test.DropDown(x => x.ControlPanelType, "CNTRLPNL_TYP");
