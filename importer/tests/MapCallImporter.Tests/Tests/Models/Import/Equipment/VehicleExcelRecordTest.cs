...
{
    [TestClass]
    public class VehicleExcelRecordTest : EquipmentExcelRecordTestBase<VehicleExcelRecord>
    {
        #region Private Methods

        protected override VehicleExcelRecord CreateTarget()
        {
        ...
        protected override string ExpectedIdentifier => "NJ7-10-VEHG-1";
        ...
        protected override void TestCharacteristicMappings(
            EquipmentCharacteristicMappingTester<VehicleExcelRecord> test)
        {
            ...
            test.DropDown(x => x.VehicleType, "VEH_TYP");
