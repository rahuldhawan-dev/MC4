...
{
    [TestClass]
    public class RecorderExcelRecordTest : EquipmentExcelRecordTestBase<RecorderExcelRecord>
    {
        #region Private Methods

        protected override RecorderExcelRecord CreateTarget()
        {
        ...
        protected override string ExpectedIdentifier => "NJ7-10-RCDG-1";
        ...
        protected override void TestCharacteristicMappings(
            EquipmentCharacteristicMappingTester<RecorderExcelRecord> test)
        {
            test.DropDown(x => x.DataRecorderType, "RECORDER_TYP");
