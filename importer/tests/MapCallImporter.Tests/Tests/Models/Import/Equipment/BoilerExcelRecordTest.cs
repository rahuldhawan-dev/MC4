...
{
    [TestClass]
    public class BoilerExcelRecordTest : EquipmentExcelRecordTestBase<BoilerExcelRecord>
    {
        #region Private Methods

        protected override BoilerExcelRecord CreateTarget()
        {
        ...
        protected override string ExpectedIdentifier => "NJ7-10-BLRG-1";
        ...
        protected override void TestCharacteristicMappings(
            EquipmentCharacteristicMappingTester<BoilerExcelRecord> test)
        {
            test.Numerical(x => x.AmpRating, "AMP_RATING");
            test.DropDown(x => x.Application, "APPLICATION_BOILER");
            test.DropDown(x => x.BoilerType, "BOILER_TYP");
