...
{
    [TestClass]
    public class FireAlarmExcelRecordTest : EquipmentExcelRecordTestBase<FireAlarmExcelRecord>
    {
        #region Private Methods

        protected override FireAlarmExcelRecord CreateTarget()
        {
            var ret = base.CreateTarget();

            ret.ActionTakenUponAl = "AUTO SHUT/VENTILATION";
            ret.FireAlarmType = "SINGLE DETECTOR";
            ret.OwnedBy = "AW";
        ...
        protected override string ExpectedIdentifier => "NJ7-10-FARG-1";
        ...
        protected override void TestCharacteristicMappings(
            EquipmentCharacteristicMappingTester<FireAlarmExcelRecord> test)
        {
            test.DropDown(x => x.ActionTakenUponAl, "ACTION_TAKEN_UPON_ALARM");
            test.DropDown(x => x.FireAlarmType, "FIRE-AL_TYP");
