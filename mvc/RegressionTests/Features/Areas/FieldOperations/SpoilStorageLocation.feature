...
Background: stuff exists
    ...
    And a spoil storage location "one" exists with operating center: "opc", town: "one"
    And a spoil storage location "two" exists with operating center: "opc", town: "one"
    And I am logged in as "admin"

Scenario: admin can search for locations
    When I visit the FieldOperations/SpoilStorageLocation/Search page
    ...
    And I press "Search"
    Then I should be at the FieldOperations/SpoilStorageLocation page
    And I should see a link to the Show page for spoil storage location "one"
    And I should see a link to the Show page for spoil storage location "two"

Scenario: admin can view locations
    When I visit the Show page for spoil storage location "one"
...
Scenario: admin can create locations
    When I visit the FieldOperations/SpoilStorageLocation/New page
    And I press Save
    ...
    And I press Save
    Then I should be at the FieldOperations/SpoilStorageLocation/Show/3 page

Scenario: admin can edit locations
    When I visit the Edit page for spoil storage location "one"
    And I enter "meh" into the Name field
    And I press Save
    Then I should be at the Show page for spoil storage location "one"
