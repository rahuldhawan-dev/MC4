...
namespace MapCallMVC.Areas.Engineering.Models.ViewModels.RiskRegisterActionItems
{
    public class SearchRiskRegisterActionItem : SearchSet<ActionItem<RiskRegisterAsset>>
    {
        #region Properties
