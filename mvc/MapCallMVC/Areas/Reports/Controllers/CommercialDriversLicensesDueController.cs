...
{
    [DisplayName("Drivers Licenses Due")]
    public class CommercialDriversLicensesDueController : ControllerBaseWithPersistence<IEmployeeRepository, Employee, User>
    {
        #region Constants
        ...
        public ActionResult Index(SearchCommercialDriversLicensesDue search)
        {
        ...
        [HttpGet, RequiresRole(ROLE)]
        public ActionResult Search(SearchCommercialDriversLicensesDue search)
        {
        ...
        public CommercialDriversLicensesDueController(ControllerBaseWithPersistenceArguments<IEmployeeRepository, Employee, User> args) : base(args) {}
    }
}