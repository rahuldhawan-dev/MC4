...
{
    [DisplayName("CDL Certificates of Violations Due")]
    public class CommercialDriversLicenseViolationCertificatesDueController : ControllerBaseWithPersistence<IEmployeeRepository, Employee, User>
    {
        #region Constants
        ...
        public ActionResult Index(SearchCommercialDriversLicenseViolationCertificatesDue search)
        {
        ...
        [HttpGet, RequiresRole(ROLE)]
        public ActionResult Search(SearchCommercialDriversLicenseViolationCertificatesDue search)
        {
        ...
        public CommercialDriversLicenseViolationCertificatesDueController(ControllerBaseWithPersistenceArguments<IEmployeeRepository, Employee, User> args) : base(args) {}
    }
}