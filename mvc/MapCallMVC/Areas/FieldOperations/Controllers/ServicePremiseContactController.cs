...
{
    public class ServicePremiseContactController : ControllerBaseWithPersistence<ServicePremiseContact, User>
    {
        #region Consts
        ...
        public ServicePremiseContactController(ControllerBaseWithPersistenceArguments<IRepository<ServicePremiseContact>, ServicePremiseContact, User> args) : base(args) { }
        ...
        {
            return ActionHelper.DoEdit<ServicePremiseContactViewModel>(id);
        }

        // MC-244: Only user admins can edit these records.
        [HttpPost, RequiresRole(ROLE, RoleActions.UserAdministrator)]
        public ActionResult Update(ServicePremiseContactViewModel model)
        {
