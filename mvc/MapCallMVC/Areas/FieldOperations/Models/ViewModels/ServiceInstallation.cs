...
namespace MapCallMVC.Areas.FieldOperations.Models.ViewModels
{
    public class SearchServiceInstallation  : SearchSet<ServiceInstallation> 
    {
        ...
        [DropDown, SearchAlias("WorkOrder", "wo", "OperatingCenter.Id"), EntityMap,EntityMustExist(typeof(OperatingCenter))]
    ...
    public class ServiceInstallationViewModel : ViewModel<ServiceInstallation>
    {
        ...
        public const string MATERIAL_NUMBER = "00000000";
    ...
    public class CreateServiceInstallation : ServiceInstallationViewModel
    {
        ...
        {
            base.SetDefaults();
            //  this is reset from SAP and the business requested this as the default
