...
namespace MapCallMVC.Areas.FieldOperations.Models.ViewModels
{
    public class EditMeterChangeOut : ViewModel<MeterChangeOut>
    {
        ...
        public MeterChangeOut Display
        {
            get
            {
                if (_original == null)
                {
                    _original = Original ?? _container.GetInstance<IRepository<MeterChangeOut>>().Find(Id);
                }
                return _original;
            }
        }
        ...
        public static int[] GetNotScheduledLVMOrVaultStatuses(IContainer container)
        {
            return container.GetInstance<IMeterChangeOutStatusRepository>().GetNotScheduledLVMOrVaultStatuses();
        }
    ...
    public class SearchMeterChangeOutCompletions : SearchSet<MeterChangeOutCompletionReportItem>, ISearchMeterChangeOutCompletions
    {
        ...
        public int[] MeterChangeOutStatus { get; set; }
        [SearchAlias("Contract", "OperatingCenter.Id")]
