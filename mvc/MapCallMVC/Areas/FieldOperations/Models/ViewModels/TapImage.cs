...
namespace MapCallMVC.Areas.FieldOperations.Models.ViewModels
{
    public abstract class BaseTapImageViewModel : ViewModel<TapImage>
    {
        ...
        [DropDown("FieldOperations", "Service", "ByStreetId", DependsOn = "StreetIdentifyingInteger", PromptText = "Please select a street above")]
        ...
        [StringLength(TapImage.StringLengths.CROSS_STREET)]
    ...
    public class CreateTapImage : BaseTapImageViewModel
    {
        ...
        public override TapImage MapToEntity(TapImage entity)
        {
            ...
            if (StreetIdentifyingInteger.HasValue)
            {
                ...
                entity.StreetPrefix = s.Prefix?.ToString();
                entity.StreetSuffix = s.Suffix?.ToString();
            }

            if (CrossStreetIdentifyingInteger.HasValue)
            {
                entity.CrossStreet = _container.GetInstance<IStreetRepository>().Find(CrossStreetIdentifyingInteger.Value).FullStName;
            }
    ...
    public class EditTapImage : BaseTapImageViewModel
    {
        #region Properties
        ...
        public EditTapImage(IContainer container) : base(container) { }

        #endregion

        #region Public Methods

        public override void Map(TapImage entity)
        {
            base.Map(entity);
            ...
            StreetIdentifyingInteger = entity.Service?.Street?.Id;
            CrossStreetIdentifyingInteger = entity.Service?.CrossStreet?.Id;
        }
    ...
    public class SearchTapImage : SearchSet<TapImage>
    {
        ...
        public int? Service { get; set; }
        [SearchAlias("Service", "S", "Installation")]
        public string Installation { get; set; }

        #endregion
    }

    public class SearchTapImageLink : SearchSet<TapImageLinkReportItem>
    {
        [DropDown]
