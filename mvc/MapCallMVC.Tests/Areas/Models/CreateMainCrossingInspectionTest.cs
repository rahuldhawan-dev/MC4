...
{
    [TestClass]
    public class CreateMainCrossingInspectionTest : MapCallMvcInMemoryDatabaseTestBase<MainCrossingInspection>
    {
        #region Fields

        private ViewModelTester<CreateMainCrossingInspection, MainCrossingInspection> _vmTester;
        private CreateMainCrossingInspection _viewModel;
        ...
        public void InitializeTest()
        {
            ...
            _viewModel = _viewModelFactory.Build<CreateMainCrossingInspection, MainCrossingInspection>( _entity);
            _vmTester = new ViewModelTester<CreateMainCrossingInspection, MainCrossingInspection>(_viewModel, _entity);
        }
        ...
        [TestMethod]
        public void TestMainCrossingCanMapBothWays()
        {
            var mc = GetFactory<MainCrossingFactory>().Create();
            _entity.MainCrossing = mc;
            _viewModel.MainCrossing = null;
            _vmTester.MapToViewModel();
            Assert.AreEqual(mc.Id, _viewModel.MainCrossing);

            _entity.MainCrossing = null;
            _vmTester.MapToEntity();
            Assert.AreSame(mc, _entity.MainCrossing);
        }

        [TestMethod]
        public void TestMapToEntitySetsInspectedByToCurrentUser()
        {
        ...
        public void TestAllFieldsAreRequired()
        {
            ...
            ValidationAssert.PropertyIsRequired(_viewModel, x => x.MainCrossing);
