...
{
    [TestClass]
    public class CommercialDriversLicensesDueControllerTest : MapCallMvcControllerTestBase<CommercialDriversLicensesDueController, Employee, EmployeeRepository>
    {
        #region Fields
        ...
        public override void TestControllerAuthorization()
        {
            Authorization.Assert(a =>
            {
                ...
                a.RequiresRole("~/Reports/CommercialDriversLicensesDue/Search", module);
                a.RequiresRole("~/Reports/CommercialDriversLicensesDue/Index", module);
            });
        }
        ...
        public void TestIndexXLSExportExportsExcel()
        {
            ...
            var search = new SearchCommercialDriversLicensesDue();
