...
{
    [TestClass]
    public class CommercialDriversLicenseComplianceControllerTest : MapCallMvcControllerTestBase<CommercialDriversLicenseComplianceController, Employee, EmployeeRepository>
    {
        #region Fields
        ...
        public void TestInitialize()
        {
            ...
            _target = Request.CreateAndInitializeController<CommercialDriversLicenseComplianceController>();
        }
        ...
        public override void TestControllerAuthorization()
        {
            Authorization.Assert(a => {
                ...
                a.RequiresRole("~/Reports/CommercialDriversLicenseCompliance/Search", module);
                a.RequiresRole("~/Reports/CommercialDriversLicenseCompliance/Index", module);
            });
        }
        ...
        public void TestIndexXLSExportExportsExcel()
        {
            ...
            var search = new SearchCommercialDriversLicenseCompliance();
