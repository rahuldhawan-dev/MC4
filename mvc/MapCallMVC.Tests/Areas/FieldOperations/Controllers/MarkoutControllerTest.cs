...
{
    [TestClass]
    public class MarkoutControllerTest : MapCallMvcControllerTestBase<MarkoutController, Markout>
    {
        #region Setup
        ...
        protected override void SetAutomatedTestOptions(AutomatedTestOptions options)
        {
            ...
            options.CreateValidEntity = () => {
                ...
                return GetFactory<MarkoutFactory>().Build(new {
                    WorkOrder = workOrder,
        ...
        public void TestCreateCreatesAMarkoutWithNecessaryValues()
        {
            ...
            var markoutRequirement = GetFactory<RoutineMarkoutRequirementFactory>().Create();
            var workOrder = GetFactory<WorkOrderFactory>().Create(new { MarkoutRequirement = markoutRequirement });
            var markoutType = GetFactory<MarkoutTypeFactory>().Create();
        ...
        {
            // overriding this method since it redirects to work order show page
            SetupDropDownData();
            var markoutRequirement = GetFactory<RoutineMarkoutRequirementFactory>().Create();
