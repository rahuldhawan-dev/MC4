...
{
    [TestClass]
    public class CreateCrewTest : MapCallMvcInMemoryDatabaseTestBase<Crew>
    {
        #region Fields
        ...
        [TestMethod]
        public void TestDescriptionCanMapBothWays()
        {
            var crew = GetEntityFactory<Crew>().Create(new { Description = "Foo" });
        ...
        [TestMethod]
        public void TestAvailabilityCanMapBothWays()
        {
            var crew = GetEntityFactory<Crew>().Create(new { Availability = (decimal)2.5 });
