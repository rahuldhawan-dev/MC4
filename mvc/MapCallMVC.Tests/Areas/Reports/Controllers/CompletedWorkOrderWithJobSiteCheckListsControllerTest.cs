...
{
    [TestClass]
    public class CompletedWorkOrdersWithJobSiteCheckListsControllerTest : MapCallMvcControllerTestBase<CompletedWorkOrdersWithJobSiteCheckListsController, WorkOrder, WorkOrderRepository>
    {
        [TestMethod]
        public override void TestControllerAuthorization()
        {
            ...
            Authorization.Assert(a => {
                a.RequiresRole("~/Reports/CompletedWorkOrdersWithJobSiteCheckLists/Search", role, RoleActions.UserAdministrator);
                a.RequiresRole("~/Reports/CompletedWorkOrdersWithJobSiteCheckLists/Index", role, RoleActions.UserAdministrator);
            });
        }
        ...
        {
            var search = new SearchCompletedWorkOrdersWithJobSiteCheckLists();
        ...
        public override void TestIndexReturnsResults()
        {
            ...
            var jscl = GetFactory<JobSiteCheckListFactory>().Create(new{ MapCallWorkOrder = workorder, HasExcavation = false });
            var search = new SearchCompletedWorkOrdersWithJobSiteCheckLists();
            search.DateCompleted = new MMSINC.Data.RequiredDateRange() {
                Start = DateTime.Today,
                End = DateTime.Today
        ...
        public void TestIndexSupportsExcel()
        {
            ...
            using (var helper = new ExcelResultTester(_container, result, true))
            {
                ...
                helper.AreEqual(1, "WorkOrdersWithJobSiteCheckListCount");
                helper.AreEqual(1, "PercentageWithJobSiteCheckList");
            }
        }
    }
}