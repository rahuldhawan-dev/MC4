...
{
    [TestClass]
    public class CompletedWorkOrdersWithMaterialControllerTest : MapCallMvcControllerTestBase<CompletedWorkOrdersWithMaterialController, WorkOrder, WorkOrderRepository>
    {
        [TestMethod]
        public override void TestControllerAuthorization()
        {
            ...
            Authorization.Assert(a => {
                a.RequiresRole("~/Reports/CompletedWorkOrdersWithMaterial/Search", role, RoleActions.UserAdministrator);
                a.RequiresRole("~/Reports/CompletedWorkOrdersWithMaterial/Index", role, RoleActions.UserAdministrator);
            });
        }
        ...
        {
            var search = new SearchCompletedWorkOrdersWithMaterial();
        ...
        public override void TestIndexReturnsResults()
        {
            ...
            GetEntityFactory<MaterialUsed>().Create(new { WorkOrder = workorder });
            var search = new SearchCompletedWorkOrdersWithMaterial();
            search.DateCompleted = new MMSINC.Data.RequiredDateRange()
            {
                Start = DateTime.Today,
        ...
        public void TestIndexSupportsExcel()
        {
            ...
            using (var helper = new ExcelResultTester(_container, result, true))
            {
                ...
                helper.AreEqual(1, "WorkOrdersWithMaterialCount");
                helper.AreEqual(1, "PercentageWithMaterial");
            }
        }
