...
{
    [TestClass]
    public class HydrantsDueInspectionControllerTest : MapCallMvcControllerTestBase<HydrantsDueInspectionController, Hydrant, HydrantRepository>
    {
        #region Init/Cleanup
        ...
        public override void TestControllerAuthorization()
        {
            Authorization.Assert(a => {
                a.RequiresLoggedInUserOnly("~/Reports/HydrantsDueInspection/Index");
                a.RequiresLoggedInUserOnly("~/Reports/HydrantsDueInspection/Search");
            });
        }
        ...
        public override void TestIndexReturnsResults()
        {
            ...
            var search = new SearchHydrantsDueInspectionReport { OperatingCenter = new[] { opc1.Id }};
            var result = _target.Index(search);
            MvcAssert.IsViewNamed(result, "Index");
            MvcAssert.IsViewWithNameAndModel(result, "Index", search);

           // var model = (IEnumerable<HydrantDueInspectionReportItem>)((ViewResult)result).Model;
        ...
        public void TestIndexRespondsToExcel()
        {
            ...
            var search = new SearchHydrantsDueInspectionReport();
