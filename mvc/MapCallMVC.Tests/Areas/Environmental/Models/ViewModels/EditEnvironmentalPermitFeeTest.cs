...
{
    [TestClass]
    public class EditEnvironmentalPermitFeeTest : MapCallMvcInMemoryDatabaseTestBase<EnvironmentalPermitFee>
    {
        #region Fields

        private ViewModelTester<EditEnvironmentalPermitFee, EnvironmentalPermitFee> _vmTester;
        private EditEnvironmentalPermitFee _viewModel;
        ...
        public void TestInitialize()
        {
            ...
            _viewModel = _viewModelFactory.Build<EditEnvironmentalPermitFee>();
            _vmTester = new ViewModelTester<EditEnvironmentalPermitFee, EnvironmentalPermitFee>(_viewModel, _entity);
        }
        ...
        [TestMethod]
        public void TestMapSetsOperatingCenterFromEnvironmentalPermit()
        {
            var permit = _entity.EnvironmentalPermit;
