...
// ReSharper restore CheckNamespace
    public class CustomerGateway : IExtendedCustomerGateway
    {
        ...
        {
            _gateway = new HttpXmlUtility(mode, apiLogin, transactionKey);
            _serviceMode = mode;
        }
        /// <summary>
        /// Initializes a new instance of the <see cref="CustomerGateway"/> class.
        ...
        public IGatewayResponse AuthorizeAndCapture(Order order) {
            ...
            if (_serviceMode == ServiceMode.Test)
            {
                // This defaults to 120 seconds. This causes test to flub when
                // identical orders get sent too quickly. Setting to 0 gets rid of
                // the duplicate rejection window.
                req.extraOptions = "x_duplicate_window=0";
            }
        ...
        /// <param name="amount">The amount.</param>
        /// <returns></returns>
        public IGatewayResponse Refund(string profileID, string paymentProfileId, string approvalCode, string transactionId, decimal amount)
        {
            var req = new createCustomerProfileTransactionRequest();
        ...
        /// <param name="approvalCode">The approval code.</param>
        /// <returns></returns>
        public IGatewayResponse Void(string profileID, string paymentProfileId, string approvalCode, string transactionId) {
            var req = new createCustomerProfileTransactionRequest();
        ...
        #region Not Originally Provided

        // This field is set in the constructor and is needed by the AuthorizeAndCapture method.
        private ServiceMode _serviceMode;

        public string GetHostedSessionKey(UInt32 customerProfileId, string url, bool isLive)
        {
            return MissingMethods.GetHostedSessionKey(customerProfileId, url, isLive);
        }
