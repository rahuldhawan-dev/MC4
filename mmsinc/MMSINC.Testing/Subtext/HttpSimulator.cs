    ...
    // ReSharper restore CheckNamespace
{
    ...
    {
        private const string DEFAULT_PHYSICAL_APP_PATH = @"c:\InetPub\wwwRoot\";
        private StringBuilder _builder;
        private Uri _referer;
        private NameValueCollection _formVars = new NameValueCollection();
        private NameValueCollection _headers = new NameValueCollection();

        public HttpSimulator() : this("/", DEFAULT_PHYSICAL_APP_PATH) { }

        public HttpSimulator(string applicationPath) : this(applicationPath, DEFAULT_PHYSICAL_APP_PATH) { }
            ...
            NameValueCollection headers)
        {
            ...
            _workerRequest = new SimulatedHttpRequest(ApplicationPath, PhysicalApplicationPath, PhysicalPath, Page,
                query, _responseWriter, _host, _port, httpVerb.ToString());
            ...
            Console.WriteLine("HostingEnvironment.ApplicationVirtualPath: " +
        ...
        public string PhysicalApplicationPath
        {
            ...
            set 
            {
                _physicalApplicationPath = value ?? DEFAULT_PHYSICAL_APP_PATH;
                //strip trailing backslashes.
                _physicalApplicationPath = StripTrailingBackSlashes(_physicalApplicationPath) + @"\";
            }
        }

        private string _physicalApplicationPath = DEFAULT_PHYSICAL_APP_PATH;
        ...
        private string _physicalPath = DEFAULT_PHYSICAL_APP_PATH;
        ...
        {
            get { return (_builder == null) ? String.Empty : _builder.ToString(); }
        }
        ...
        void SetHttpRuntimeInternals()
        {
            ...
            object virtualPath = ReflectionHelper.Instantiate(vpathTypeName, new Type[] {typeof(string)},
