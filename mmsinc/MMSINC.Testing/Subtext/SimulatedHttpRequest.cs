...
// Subtext WebLog
// 
// Subtext is an open _source weblog system that is a fork of the .TEXT
// weblog system.
//
    ...
    // ReSharper restore CheckNamespace
{
    ...
    public class SimulatedHttpRequest : SimpleWorkerRequest
    {
        ...
        public SimulatedHttpRequest(string applicationPath, string physicalAppPath, string physicalFilePath,
            string page, string query, TextWriter output, string host, int port, string verb) : base(applicationPath,
            physicalAppPath, page, query, output)
        {
            if (host == null)
        ...
        private NameValueCollection _formVariables = new NameValueCollection();
        ...
        public override byte[] GetPreloadedEntityBody()
        {
            ...
            {
                formText += string.Format("{0}={1}&", key, _formVariables[key]);
            }
