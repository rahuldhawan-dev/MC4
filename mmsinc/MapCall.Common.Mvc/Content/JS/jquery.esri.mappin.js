...
(function($, esri, dojo, require) {
  ...
  var getMapCallback = function($this, attr, callback) {
    return function(response) {
      ...
      if (attr.locateButton) {
              new esri.dijit.LocateButton({ map: response.map }, attr.locateButton).startup();
      }
   ...
   * @param {object} obtions.locateButtonId - object for locate button
