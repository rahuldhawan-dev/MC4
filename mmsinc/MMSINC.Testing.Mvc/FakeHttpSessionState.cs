...
namespace MMSINC.Testing
{
    public class FakeHttpSessionState : HttpSessionStateBase
    {
        ...
        {
            get { return this._sessionItems.Count; }
        }

        public override object this[string name]
        {
            get { return this._sessionItems[name]; }
            set { this._sessionItems[name] = value; }
        }

        public override object this[int index]
        {
            get { return this._sessionItems[index]; }
            set { this._sessionItems[index] = value; }
        }

        public override NameObjectCollectionBase.KeysCollection Keys
        {
            get { return this._sessionItems.Keys; }
        }
    }
}
