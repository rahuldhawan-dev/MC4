...
namespace MMSINC.Testing
{
    public class FakeHttpRequest : HttpRequestBase
    {
        ...
        // Methods
        public FakeHttpRequest(Uri url, string appRelativeUrl, string httpMethod, bool isAuthenticated,
        ...
        {
            get { return this._appRelativeUrl; }
        }
        ...
        {
            get { return ((this.Url.Host.ToLower() == "localhost") || (this.Url.Host == "127.0.01")); }
        }
