...
{
    [Migration(20180604122541539), Tags("Production")]
    public class AdjustShortCycleFieldLengthsAndTypes : Migration
    {
        public override void Up()
        {
            Alter.Table("ShortCycleWorkOrderTimeConfirmations")
                 .AlterColumn("WorkStartTime").AsAnsiString(8)
                 .AlterColumn("WorkFinishTime").AsAnsiString(8);
            Execute.Sql(
        ...
        {
            //Alter.Table("ShortCycleWorkOrderTimeConfirmations")
            //    .AlterColumn("WorkStartTime").AsAnsiString(6)
            //    .AlterColumn("WorkFinishTime").AsAnsiString(6);
            Execute.Sql(
