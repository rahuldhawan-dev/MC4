...
{
    [Migration(20180907102728186), Tags("Production")]
    public class AlterHydrantsDueInspectionViewToExcludeHydrantsNeverPreviouslyInspectedForMC78 : Migration
    {
        public struct Sql
        {
...
ON hyd.OperatingCenterId = oc.OperatingCenterID";
        ...
        {
            Execute.Sql(CreateHydrantInspectionViewForMC78.Sql.DROP_HYDRANT_VIEW);
        ...
        {
            Execute.Sql(CreateHydrantInspectionViewForMC78.Sql.DROP_HYDRANT_VIEW);
            Execute.Sql(CreateHydrantInspectionViewForMC78.Sql.CREATE_HYDRANT_VIEW_SQL_FORMAT, "GetDate()");
        }
    }
}
