...
{
    [Migration(20200416095831988), Tags("Production")]
    public class MC2204IncreaseContractorUserEmailLength : Migration
    {
        public override void Up()
        {
            ...
            Alter.Column("Email").OnTable("ContractorUsers").AsString(256).NotNullable();
