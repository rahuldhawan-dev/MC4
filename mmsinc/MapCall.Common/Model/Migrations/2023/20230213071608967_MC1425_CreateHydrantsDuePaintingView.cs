...
{
    [Migration(20230213071608967), Tags("Production")]
    public class MC1425_CreateHydrantsDuePaintingView : Migration
    {
        public const string DROP_VIEW = "DROP VIEW [HydrantsDuePaintingView]";
