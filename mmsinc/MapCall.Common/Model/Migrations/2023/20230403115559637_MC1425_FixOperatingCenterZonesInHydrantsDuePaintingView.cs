...
using PreviousMigration =
    MapCall.Common.Model.Migrations._2023.MC1425_AddInstalledStatusAndLastPaintedAtToHydrantsDuePaintingView;

namespace MapCall.Common.Model.Migrations._2023
{
    [Migration(20230403115559637), Tags("Production")]
    public class MC1425_FixOperatingCenterZonesInHydrantsDuePaintingView : Migration
    {
        public const string DROP_VIEW = PreviousMigration.DROP_VIEW;

        public const string CREATE_VIEW = @"CREATE VIEW [HydrantsDuePaintingView] AS
     ...
     LEFT JOIN SelectedHydrantPaintings moreRecent
       ...
       SELECT DISTINCT
           ...
           CASE
               ...
               -- IN THIS YEAR'S ZONE
               WHEN operatingCenter.PaintingZoneStartYear IS NOT NULL AND hydrant.PaintingZone IS NOT NULL
               THEN IIF(
                   hydrant.PaintingZone =
                       ((ABS(operatingCenter.PaintingZoneStartYear - YEAR(GETDATE())) %
