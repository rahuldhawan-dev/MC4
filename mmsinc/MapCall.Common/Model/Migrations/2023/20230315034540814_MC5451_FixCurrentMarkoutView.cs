...
{
    [Migration(20230315034540814), Tags("Production")]
    public class MC5451_FixCurrentMarkoutView : Migration
    {
        public const string VIEW_NAME = MC5406_CreateCurrentMarkoutView.VIEW_NAME;

        public const string OLD_VIEW_SQL = MC5406_CreateCurrentMarkoutView.VIEW_SQL;
