...
using LastMigration = MapCall.Common.Model.Migrations._2023.MC1425_ImproveHydrantsDueInspectionView;

namespace MapCall.Common.Model.Migrations._2023
{
    [Migration(20230224080123050), Tags("Production")]
    public class MC1425_AddLastInspectionDateToHydrantsDueInspectionView : Migration
    {
        private const string OLD_CREATE_VIEW = LastMigration.CREATE_VIEW;
        public const string DROP_VIEW = LastMigration.DROP_VIEW;
    ...
    INNER JOIN SelectedAssetStatuses status ON status.AssetStatusID = hydrant.AssetStatusId
     ...
     LEFT JOIN SelectedHydrantInspections moreRecent
       ...
       SELECT DISTINCT
           ...
           inspection.DateInspected AS LastInspectionDate
