...
{
    public class WellTestRepository : MapCallSecuredRepositoryBase<WellTest>, IWellTestRepository
    {
        #region Properties
        ...
        public override IQueryable<WellTest> Linq
        {
            get
            {
                if (CurrentUserCanAccessAllTheRecords)
        ...
        public WellTestRepository(
            ISession session,
            IContainer container,
            IAuthenticationService<User> authenticationService, 
            IRepository<AggregateRole> roleRepository
        ) : base(session, container, authenticationService, roleRepository) { }

        #endregion
    }

    public interface IWellTestRepository : IRepository<WellTest> { }
}
