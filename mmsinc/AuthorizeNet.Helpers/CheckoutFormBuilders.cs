...
namespace AuthorizeNet.Helpers
{
    ...
    public static class CheckoutFormBuilders
    {
        ...
        /// </summary>
        public static SIMForm BeginSIMForm(this HtmlHelper helper, string returnUrl, decimal amount, string apiLogin,
            string transactionKey)
        {
            return new SIMForm(helper.ViewContext.Writer, returnUrl, amount, apiLogin, transactionKey, true);
        }

        public static SIMForm BeginSIMForm(this HtmlHelper helper, string returnUrl, decimal amount, string apiLogin,
            string transactionKey, bool isTest)
        {
            return new SIMForm(helper.ViewContext.Writer, returnUrl, amount, apiLogin, transactionKey, isTest);
        }

        /// <summary>
        /// Outputs an input box specifically for a CreditCard, API-ready with proper naming for the SDK
        /// </summary>
        public static MvcHtmlString CreditCardInput(this HtmlHelper helper)
        {
        ...
        /// </summary>
        public static MvcHtmlString CreditCardInput(this HtmlHelper helper, bool forTest)
        {
            return MvcHtmlString.Create(
                "<input type = \"text\" size = \"36\" name = \"card_num\" value = \"4111111111111111\"/>");
        }

        /// <summary>
        /// A small textbox for inputing the secret codebox 
        /// </summary>
        public static MvcHtmlString CCVInput(this HtmlHelper helper)
        {
            return MvcHtmlString.Create(
        ...
        /// </summary>
        public static MvcHtmlString CreditCardExpirationInput(this HtmlHelper helper)
        {
            return MvcHtmlString.Create(
                "<input type = \"text\" size = \"3\" maxlength = \"3\" name = \"x_card_code\" />");
        }
        ...
        /// <returns></returns>
        public static MvcHtmlString CheckoutFormInputs(this HtmlHelper helper)
        {
        ...
        /// </summary>
        public static MvcHtmlString CheckoutFormInputsWithAddress(this HtmlHelper helper, bool isTest)
        {
        ...
        /// according to API guidelines and are ready for use with the FormReaders
        /// </summary>		
        public static MvcHtmlString CheckoutFormInputsWithShipping(this HtmlHelper helper, bool isTest)
        {
            var sb = new StringBuilder();
            sb.Append(CheckoutFormInputs(helper, isTest));
            sb.AppendLine("<div style='height:24px'></div>");
        ...
        /// according to API guidelines and are ready for use with the FormReaders
        /// </summary>
        public static MvcHtmlString CheckoutFormInputsWithAddressAndShipping(this HtmlHelper helper, bool isTest)
        {
            var sb = new StringBuilder();
            sb.Append(CheckoutFormInputs(helper, isTest));
            sb.AppendLine("<div style='height:24px'></div>");
        ...
        public static MvcHtmlString CheckoutFormInputs(this HtmlHelper helper, bool isTest)
        {
        ...
        /// </summary>
        public static MvcHtmlString CreditCardForm(bool isTest)
        {
            ...
            return MvcHtmlString.Create(inputs);
        }

        public static MvcHtmlString AddressForm()
        {
            var form = @"
				<h2>Address</h2>
        ...
        public static MvcHtmlString ShippingForm()
        {
            var form = @"
				<h2>Shipping</h2>
				<div style='float:left;width:180px;padding-right:10px'>
        ...
        /// <returns></returns>
        public static MvcHtmlString Redirecter(string toUrl)
        {
            return
                MvcHtmlString.Create(
                    string.Format(
                        "<html><head><script type='text/javascript' charset='utf-8'>	window.location='{0}';</script><noscript><meta http-equiv='refresh' content='1;url={0}'></noscript></head><body></body></html>",
                        toUrl));
        }
    }
}
