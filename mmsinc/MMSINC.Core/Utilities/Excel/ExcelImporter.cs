...
namespace MMSINC.Utilities.Excel
{
        ...
        where TParser : IExcelParser<TOutput>
    {
        ...
        protected IEnumerable<TOutput> ParsePackage(FileInfo excelFile,
            Func<ExcelPackage, ExcelWorksheet> getWorksheetFn)
        {
    ...
    public class ExcelImporter<TOutput> : ExcelImporterBase<TOutput, ByColumnNameExcelParser<TOutput>>
    {
        #region Constructors

        public ExcelImporter(ByColumnNameExcelParser<TOutput> parser) : base(parser) { }
