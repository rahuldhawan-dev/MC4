...
{
    [TestClass]
    public class OperatorLicenseExpirationIn60DaysTest : OperatorLicenseExpirationBaseTest<OperatorLicenseExpirationIn60Days>
    {
        #region Tests
        ...
        {
            var targetExpirationDate = _dateTimeProvider.Object.GetCurrentDate().AddDays(60);
            ...
            var subjectLine = $"Licensed Operator Renewal Due in 60 Days, Expiration Date: {targetExpirationDate}";
