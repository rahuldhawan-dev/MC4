...
{
    [TestClass]
    public class OperatorLicenseExpirationIn15DaysTest : OperatorLicenseExpirationBaseTest<OperatorLicenseExpirationIn15Days>
    {
        #region Tests
        ...
        {
            var targetExpirationDate = _dateTimeProvider.Object.GetCurrentDate().AddDays(15);
            ...
            var subjectLine = $"Licensed Operator Renewal Due in 15 Days, Expiration Date: {targetExpirationDate}";
