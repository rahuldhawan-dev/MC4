...
{
    [TestClass]
    public class OperatorLicenseExpirationIn30DaysTest : OperatorLicenseExpirationBaseTest<OperatorLicenseExpirationIn30Days>
    {
        #region Tests
        ...
        {
            var targetExpirationDate = _dateTimeProvider.Object.GetCurrentDate().AddDays(30);
            ...
            var subjectLine = $"Licensed Operator Renewal Due in 30 Days, Expiration Date: {targetExpirationDate}";
