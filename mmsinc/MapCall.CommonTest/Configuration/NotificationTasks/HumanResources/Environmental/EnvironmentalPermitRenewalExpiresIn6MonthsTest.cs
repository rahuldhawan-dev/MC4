...
{
    [TestClass]
    public class EnvironmentalPermitRenewalExpiresIn6MonthsTest : EnvironmentalPermitExpirationBaseTest<EnvironmentalPermitRenewalExpiresIn6Months>
    {
        #region Tests
        ...
        public void TestNotifyCalledForJustAnEntityPurposeAndNotAllPurposesInAConfiguration()
        {
            ...
            _notificationService.Verify(x => x.Notify(_operatingCenter.Id,
                ...
                string.Format(
                    ...
                    EnvironmentalPermitRenewalExpiresIn6Months.RENEWAL_TEXT),
                null,
        ...
        {
            var renewalDate = _currentDateTime.AddWeeks(24);
