...
{
    [TestClass]
    public class EnvironmentalPermitRenewalExpiresIn1DayTest : EnvironmentalPermitExpirationBaseTest<EnvironmentalPermitRenewalExpiresIn1Day>
    {
        #region Tests
            ...
            _notificationService.Verify(x => 
                    x.Notify(_operatingCenter.Id,
                        ...
                        string.Format(
                            ...
                            EnvironmentalPermitRenewalExpiresIn1Day.RENEWAL_TEXT),
                        null,
                        EnvironmentalPermitRenewalExpirationBase.TEMPLATE_NAME), 
                Times.Once());
        ...
        {
            var renewalDate = _currentDateTime.AddDays(1);
