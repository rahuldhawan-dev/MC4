...
{
    [TestClass]
    public class FieldServicesServiceInstalledTest : BaseNotificationTest
    {
        [TestMethod]
        public void TestNotificationIsGeneratedCorrectly()
        {
            ...
            var streamPath =
                "MapCall.Common.Resources.NotificationTemplates.FieldServices.Assets.NewServiceInstalled.cshtml";
            var template = RenderTemplate(streamPath, new ServiceNotification {Service = service});
            Assert.AreEqual(@"
<h2>Service - New Installation Notification</h2>
