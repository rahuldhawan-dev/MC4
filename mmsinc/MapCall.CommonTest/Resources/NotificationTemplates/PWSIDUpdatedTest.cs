...
{
    [TestClass]
    public class PWSIDUpdatedTest : BaseNotificationTest
    {
        public const string NOTIFICATION_PATH_FORMAT_UPDATED =
            "MapCall.Common.Resources.NotificationTemplates.Environmental.WaterSystems.PWSIDStatusChange.cshtml";
        ...
        public void TestPWSIDTrigger()
        {
            ...
            var template = RenderTemplate(NOTIFICATION_PATH_FORMAT_UPDATED, model);
...
Anticipated Active Date: ", template);
        ...
        public void TestPSWIDTriggerWhenAllNullableValuesAreNull()
        {
            ...
            var template = RenderTemplate(NOTIFICATION_PATH_FORMAT_UPDATED, model1);
...
Anticipated Active Date: ", template);
        ...
        public void TestPWSIDMultiOperatingCenter()
        {
            ...
            var template = RenderTemplate(NOTIFICATION_PATH_FORMAT_UPDATED, model2);
