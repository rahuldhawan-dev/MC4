...
{
    [TestClass]
    public class FieldServicesServiceRenewalRecordClosedTest : BaseNotificationTest
    {
        [TestMethod]
        public void TestNotificationIsGeneratedCorrectly()
        {
            var service = new Service {
                ...
                PremiseNumber = "321",
                OperatingCenter =
                    new OperatingCenter {OperatingCenterCode = "NJ7", OperatingCenterName = "Shrewsburghy"},
            ...
            var streamPath =
                "MapCall.Common.Resources.NotificationTemplates.FieldServices.Assets.ServiceRenewalRecordClosed.cshtml";
            var template = RenderTemplate(streamPath, new ServiceNotification {Service = service});
            Assert.AreEqual(@"
<h2>Service Renewal - Installation Notification</h2>
