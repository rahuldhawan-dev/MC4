...
{
    [TestClass]
    public class GetNotificationInvokerTest
    {
        ...
        private class TestInvoker : GetNotificationInvoker
        {
            #region Properties
        ...
        public void TestInvokeSetsStatusToNoDataFoundWhenNoResponse()
        {
            ...
            var searchNotification = new SearchSapNotification {
                Code = "code_1",
                Complete = "Complete",
            ...
            _targetEntity.SearchSapNotifications = searchNotification;
            ...
            Assert.AreEqual(GetNotificationInvoker.NO_DATA_FOUND, _targetEntity.SAPNotificationCollections.SAPErrorCode);
        }
        ...
        {
            Assert.AreEqual(2, _target.SendTimeOut.Value.Minutes);
        }
