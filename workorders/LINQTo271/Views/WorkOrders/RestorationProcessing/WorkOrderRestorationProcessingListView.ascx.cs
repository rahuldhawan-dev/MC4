...
{
    public partial class WorkOrderRestorationProcessingListView : WorkOrderListView
    {
        #region Constants

        private static readonly Color COMPLETED_ORDER_ROW_COLOR = Color.GreenYellow;
