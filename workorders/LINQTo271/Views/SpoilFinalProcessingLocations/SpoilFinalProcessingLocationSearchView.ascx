<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SpoilFinalProcessingLocationSearchView.ascx.cs" Inherits="LINQTo271.Views.SpoilFinalProcessingLocations.SpoilFinalProcessingLocationSearchView" %>
