...
{
    public partial class AverageCompletionTimesByWorkDescription : WorkOrdersReport
    {
        #region Event Handlers

        protected void gvSearchResults_DataBinding(object sender, EventArgs e)
        {
            ((MvpGridView)sender).DataSource = CrewAssignmentRepository
                .GetWorkOrderTimeAveragesByWorkDescription(
        ...
        protected void gvSearchResults_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                var th = new TableHeaderCell {
                    ...
                    Text = ddlOperatingCenter.SelectedIndex > 0 ?
                        String.Format("{0} from {1} - {2}",
                            ddlOperatingCenter.SelectedItem.Text,
