<%@ Page Title="Average Completion Times" Language="C#" Theme="bender" MasterPageFile="~/WorkOrders.Master" AutoEventWireup="true" CodeBehind="AverageCompletionTimes.aspx.cs" Inherits="LINQTo271.Views.Reports.AverageCompletionTimes" %>
    ...
    <mmsinc:MvpPanel runat="server" ID="pnlResults" Visible="false">
        ...
        <mmsinc:MvpGridView runat="server" ID="gvSearchResults" OnSorting="gvSearchResults_Sorting"
            ...
            <Columns>
                ...
                <mmsinc:MvpBoundField HeaderText="Average Time To Complete (hrs)" DataFormatString="{0:0.00}" DataField="Completion" />
