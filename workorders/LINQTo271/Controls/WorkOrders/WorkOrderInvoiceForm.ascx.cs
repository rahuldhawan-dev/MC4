...
{
    public partial class WorkOrderInvoiceForm : WorkOrderDetailControlBase, IWorkOrderInvoiceForm
    {
        ...
        {
            DataSource = Repository.Get(workOrderID).WorkOrderInvoices;
        }
    }

    public interface IWorkOrderInvoiceForm : IWorkOrderDetailControl
    {
