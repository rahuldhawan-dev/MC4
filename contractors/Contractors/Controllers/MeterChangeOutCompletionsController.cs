...
{
    [RequiresAdmin]
    public class MeterChangeOutCompletionsController : ControllerBaseWithValidation<IMeterChangeOutRepository, MeterChangeOut>
    {
        #region Constructors

        public MeterChangeOutCompletionsController(ControllerBaseWithPersistenceArguments<IMeterChangeOutRepository, MeterChangeOut, ContractorUser> args) : base(args) { }
