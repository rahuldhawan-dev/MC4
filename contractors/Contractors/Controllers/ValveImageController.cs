...
{
    public class ValveImageController : ControllerBaseWithValidation<IValveImageRepository, ValveImage>
    {
        #region Constants
        ...
        public ValveImageController(ControllerBaseWithPersistenceArguments<IValveImageRepository, ValveImage, ContractorUser> args) : base(args) { }
    }
}